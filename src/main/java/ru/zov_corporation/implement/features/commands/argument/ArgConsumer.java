...
package ru.zov_corporation.implement.features.commands.argument;
...
import ru.zov_corporation.api.feature.command.datatypes.IDatatype;
import ru.zov_corporation.api.feature.command.datatypes.IDatatypeContext;
import ru.zov_corporation.api.feature.command.datatypes.IDatatypeFor;
import ru.zov_corporation.api.feature.command.datatypes.IDatatypePost;
import ru.zov_corporation.api.feature.command.exception.CommandException;
import ru.zov_corporation.api.feature.command.exception.CommandInvalidTypeException;
import ru.zov_corporation.api.feature.command.exception.CommandNotEnoughArgumentsException;
import ru.zov_corporation.api.feature.command.exception.CommandTooManyArgumentsException;
import ru.zov_corporation.api.feature.command.manager.ICommandManager;
