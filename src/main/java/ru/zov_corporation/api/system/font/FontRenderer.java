package ru.zov_corporation.api.system.font;
...
import ru.zov_corporation.api.system.font.entry.DrawEntry;
import ru.zov_corporation.api.system.font.glyph.Glyph;
import ru.zov_corporation.api.system.font.glyph.GlyphMap;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("zov_corporation", "temp/" + StringUtil.randomString(32));
    }
