package ru.zov_corporation.implement.screens.menu.components.implement.window.implement.settings.color;
...
import ru.zov_corporation.implement.screens.menu.components.implement.window.implement.settings.color.component.*;
